...
# MAGIC 
# MAGIC **PART 7/7 - Data Engineer: Model inference**
# MAGIC 1. Load model from Central Registry
# MAGIC 2. Create Spark UDF
# MAGIC 3. Define input data source (i.e. table, files, Feature Store)
# MAGIC 4. Run batch inference
# MAGIC 5. Store results into table (i.e. Delta table, AzureSQL)

# COMMAND ----------

# MAGIC %md
# MAGIC <img src="https://github.com/diganparikh-dp/Images/blob/main/ML%20End%202%20End%20Workflow/MLOps%20end2end%20-%20Corvel_DE2.jpg?raw=true" width=860/>
