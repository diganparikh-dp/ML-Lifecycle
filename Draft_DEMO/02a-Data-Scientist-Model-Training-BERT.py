...
# MAGIC 1. Fine-Tune BERT model 
# MAGIC 2. Log artifacts to MLflow/Model Registry
# MAGIC 3. _Build Feature Sequences and Push to Feature Store (WORK_IN_PROGRESS)_
...
bert_model_loaded = mlflow.pytorch.load_model(bert_best_model_uri)
# bert_model_loaded = mlflow.pytorch.load_model(bert_best_model_uri, dst_path=artifacts_global["BERT_MODEL_PATH"]) # To also save MLflow artifacts to a destination path
...
# MAGIC %md
# MAGIC ### Transition latest/best run as 'Production'
# MAGIC _OPTIONAL_
